...
def update_user(i) -> None:
    ...
    users[i].marker.delete()
    users[i].marker=map_widget.set_marker(users[i].cords[0],users[i].cords[1])
...
def show_user_details() -> None:
    ...
    map.widget.set_position(users[i].coords[0], users[i].coords[1])
...
# ramka szczegoly obiektu - zawartosc
